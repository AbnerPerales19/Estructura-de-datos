...
public class P24_ListasDoblementeEnlazadas_Peek {
	...
	public static void main(String[] args) {
		...
		P24_ListasDoblementeEnlazadas_Peek le = new P24_ListasDoblementeEnlazadas_Peek();
		le.CrearLista();
	}
	...
	public  void Menu(){//Este es el menu inicial, despliega todas las opciones que el usuario puede elegir
		...
		Print("4. Ver dato de algun nodo");
		Print("5. Ver todos los nodos en retroceso.");
