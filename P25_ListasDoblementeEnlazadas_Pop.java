...
public class P25_ListasDoblementeEnlazadas_Pop {
	...
	public static void main(String[] args) {
		...
		P25_ListasDoblementeEnlazadas_Pop le = new P25_ListasDoblementeEnlazadas_Pop();
		le.CrearLista();
	}
	...
	public  void Menu(){//Este es el menu inicial, despliega todas las opciones que el usuario puede elegir
		...
		Print("6. Ver todos los nodos en retroceso.");
	...
	//Este es el metodo para eliminar nodos
	public  void EliminarNodo(){
		...
		q = raiz.next;
		aux = raiz;
		if(yy.equals(raiz.data)) { //Si el dato es igual a la raiz se despliega el mensaje
			Print("Raiz: " + raiz.data + " con indice 0 ha sido eliminada.");
			Print(raiz.next.data + " Es la nueva raiz.");
			c--;
			q = raiz;
			raiz = null;
			raiz = q.next;
			...
			if(yy.equals(p.data)){
				Print("Nodo: " + p.data + " con indice " + c + " ha sido eliminado.");
				...
				for(int d = 1; d < c; d++) { //si no es igual a la raiz entonces se busca entre los nodos y se despliega el correcto
					...
					if(yy.equals(q.data)) {
						Print("Nodo: " + q.data + " con indice " + d + " ha sido eliminado");
						m = true;
						aux.next = q.next;
						q = null;
						q = aux.next;
					...
					aux = aux.next;
					q = q.next;
					if(d == c - 1 && m == false) { //Si no existe ningun dato con ese criterio se despliega el mensaje.
